<?php
$page_title = "Maestro Soft Ltd. | Kamrul Group";
include("header.php");
?>
<div class="page-header-banner">
    <div class="container">
        <h1>Maestro Soft Ltd.</h1>
    </div>
</div>
<div class="container" style="padding-bottom: 60px;">
    <div class="row">
        <div class="col-md-8">
            <h2 style="color:#072e59; font-weight:700; margin-top:0;">About Maestro Soft Ltd.</h2>
            <p style="font-size: 16px; line-height: 1.8; color:#475569; text-align: justify; margin-top: 20px;">
                A premier software development powerhouse building enterprise ERP, web platforms, financial switching systems, and mobile applications.
            </p>
