...
<div class="page-header-banner">
    <div class="container">
        <h1>Worker Welfare Watch SDN BHD</h1>
    </div>
</div>
<div class="container" style="padding-bottom: 60px;">
    <div class="row">
        <div class="col-md-8">
            <h2 style="color:#072e59; font-weight:700; margin-top:0;">About Worker Welfare Watch SDN BHD</h2>
            <p style="font-size: 16px; line-height: 1.8; color:#475569; text-align: justify; margin-top: 20px;">
                Championing expatriate worker rights, digital welfare monitoring, safety standards, and insurance solutions.
            </p>
