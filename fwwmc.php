<?php
$page_title = "Worker Welfare Watch SDN BHD. | Kamrul Group";
include("header.php");
?>
...
<style>
    ...
    .fwwmc-website-link a {
        color: #2da1d7;
        font-weight: 500;
        text-decoration: none;
        transition: color 0.2s ease;
    }
    .fwwmc-website-link a:hover {
        color: #072e59;
        text-decoration: underline;
    }
</style>

<div class="section-area fwwmc-page-section" style="background-image: none;">
    <div class="container">
        <!-- Main Title matching pages/fwwmc.png -->
        <h1 class="fwwmc-main-title">Worker Welfare Watch SDN BHD.</h1>

        <!-- Top Description Text matching pages/fwwmc.png -->
        <p class="fwwmc-description-text">
        ...
        <!-- Website Link matching pages/fwwmc.png -->
        <div class="fwwmc-website-link">
            Website : &nbsp; <a href="http://workerwelfarewatch.com/" target="_blank">Worker Welfare Watch SDN BHD.</a>
        </div>
    </div>
</div>
