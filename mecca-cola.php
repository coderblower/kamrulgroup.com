...
<div class="page-header-banner">
    <div class="container">
        <h1>Mecca Cola, Bangladesh</h1>
    </div>
</div>
<div class="container" style="padding-bottom: 60px;">
    <div class="row">
        <div class="col-md-8">
            <h2 style="color:#072e59; font-weight:700; margin-top:0;">About Mecca Cola, Bangladesh</h2>
            <p style="font-size: 16px; line-height: 1.8; color:#475569; text-align: justify; margin-top: 20px;">
                The official franchise and production partnership bringing the world-renowned beverage brand Mecca Cola to consumers in Bangladesh with international quality standards.
            </p>
