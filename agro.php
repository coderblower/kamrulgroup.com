<?php
$page_title = "Kamrul Agro Food Industries Ltd. | Kamrul Group";
include("header.php");
?>

<div class="section-area" style="background-image: none; padding-top: 35px;">
    <div class="container">
        <div class="row">
            <div class="col-md-1 hidden-xs hidden-sm"></div>
            <div class="col-md-10 col-xs-12">
                <h1 style="color: #333333; font-weight: 700; font-size: 32px; margin-top: 10px; margin-bottom: 20px;">Kamrul Agro Food Industries Ltd.</h1>
    ...
    <div class="container" style="margin-top: 30px;">
        <div class="row">
            <div class="col-md-1 hidden-xs hidden-sm"></div>
            <div class="col-md-10 col-xs-12">
                <h1 style="color: #333333; font-weight: 700; font-size: 32px; margin-bottom: 25px;">Kamrul Agro Factory</h1>
            </div>
            <div class="col-md-1 hidden-xs hidden-sm"></div>
        </div>

        <!-- Row 1: Plastic Section & Mixing and preparation section -->
        <div class="row">
            <div class="col-md-1 hidden-xs hidden-sm"></div>
        ...
        <!-- Row 2: Rinsing, Filling and Capping Section & Labeling and packing section -->
    ...
    <div class="container" style="margin-top: 30px;">
        <div class="row">
            <div class="col-md-1 hidden-xs hidden-sm"></div>
            <div class="col-md-10 col-xs-12">
                <h1 style="color: #333333; font-weight: 700; font-size: 32px; margin-bottom: 25px;">Kamrul Agro Products</h1>
                <iframe src="carousel1.php" height="150" width="100%" frameborder="0" style="border: none; overflow: hidden; margin-bottom: 20px;" scrolling="no"></iframe>
            </div>
            <div class="col-md-1 hidden-xs hidden-sm"></div>
        </div>
    </div>
