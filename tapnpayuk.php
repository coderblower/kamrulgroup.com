...
<div class="page-header-banner">
    <div class="container">
        <h1>Tap N Pay (UK) Ltd.</h1>
    </div>
</div>
<div class="container" style="padding-bottom: 60px;">
    <div class="row">
        <div class="col-md-8">
            <h2 style="color:#072e59; font-weight:700; margin-top:0;">About Tap N Pay (UK) Ltd.</h2>
            <p style="font-size: 16px; line-height: 1.8; color:#475569; text-align: justify; margin-top: 20px;">
                Headquartered in London, providing European remittance corridors and next-generation mobile banking services.
            </p>
