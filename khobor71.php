<?php
$page_title = "Khobor71 | Kamrul Group";
include("header.php");
?>
...
<div class="container" style="padding-bottom: 60px;">
    <div class="row">
        <div class="col-md-8">
            <h2 style="color:#072e59; font-weight:700; margin-top:0;">About Khobor71</h2>
            <p style="font-size: 16px; line-height: 1.8; color:#475569; text-align: justify; margin-top: 20px;">
                A fast-growing dynamic national online news portal delivering unbiased news, investigative journalism, and business updates.
            </p>
